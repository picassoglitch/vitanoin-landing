...
const COLUMNS = [
  ...
  text('Usuario TikTok', 20, (r) => r.tiktok_handle),
  text('Enlace TikTok', 38, (r) => r.tiktok_link),
  numeric('Seguidores', 14, (r) => r.follower_count, '#,##0'),
  numeric('Engagement (%)', 15, (r) => r.engagement_rate, '0.00'),
  numeric('True Engagement (%)', 19, (r) => r.true_engagement_rate, '0.00'),
  numeric('Views promedio mensuales', 24, (r) => r.avg_reel_views, '#,##0'),
